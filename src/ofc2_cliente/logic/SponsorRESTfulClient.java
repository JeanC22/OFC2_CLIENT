...
public class SponsorRESTfulClient implements SponsorManager {
    ...
    /**
     * Update Sponsor entity XML and send it as a request to update it to the
     * SponsorRESTful web service
     *
    ...
    /**
     * Create Sponsor entity XML and send it as a request to create it to the
     * SponsorRESTful.
     *
    ...
    /**
     * Delete Sponsor identified by its id and send a request to the
     * SponsorRESTful web service
     *
